...
/***/ function(module, exports, __webpack_require__) {
	...
	var Follower = function (_React$Component) {
	    ...
	    function Follower(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Follower).call(this, props));
	    }

	    _createClass(Follower, [{
	        key: 'ClickMe',
	        value: function ClickMe(e) {
	            console.log(e.target, '-', this);
	            _reactDom2.default.unmountComponentAtNode(e.target);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'li',
	                { onClick: this.ClickMe, className: this.props.className },
	                this.props.children
	            );
	        }
	    }]);
	...
	var GithubFollowers = function (_React$Component2) {
	    _inherits(GithubFollowers, _React$Component2);

	    function GithubFollowers(props) {
	        _classCallCheck(this, GithubFollowers);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(GithubFollowers).call(this, props));

	        _this2.state = { followers: [] };
	        return _this2;
	    }

	    _createClass(GithubFollowers, [{
	        key: 'componentWillMount',
	        value: function componentWillMount() {
	            var _this3 = this;

	            fetch('https://api.github.com/users/wilsson/followers').then(function (response) {
	                return response.json();
	            }).then(function (followers) {
	                _this3.setState({ followers: followers });
	            ...
	            if (this.state.followers.length > 0) {
	                return _react2.default.createElement(
	                    ...
	                    this.state.followers.map(function (follower) {
	                        return _react2.default.createElement(
	                            Follower,
	                            { id: 'seguidor', className: follower.login },
	...
	_reactDom2.default.render(_react2.default.createElement(GithubFollowers, null), document.getElementById('container'));
